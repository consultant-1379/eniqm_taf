...
my $TCID="TC_SNMP_1";
my $TC_Name="Check Topology file for Firewall node";
my $TC_Result;
my $Total_time=0;
...
my @NODES;
my $NODE_TXT="/home/nmsadm/ENIQ-M_Automation_Suite/Nodes/Firewall.txt";
my $Topology_File;
my $T_PATH;
my $S_PATH;
my $EV_S_PATH;
...
sub testcase()
{
	...
	print FT Date(),">>> Checking Topology file for Firewall nodes";
	print FT "=============================================";
	
	print FT Date(),"Reading Firewall node info from '$NODE_TXT'";
