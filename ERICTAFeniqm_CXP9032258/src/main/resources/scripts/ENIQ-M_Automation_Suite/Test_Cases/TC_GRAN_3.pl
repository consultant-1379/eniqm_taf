...
my $TCID="TC_GRAN_3";
my $TC_Name="Check for LBG topology file";
my $TC_Result;
my $Total_time=0;
...
my $LBG_T_FILE="$ENIQ_VOLUME_MT_POINT/outputfiles/gran/topologyData/LBG/LBG";
my $LBG_S_SymLink="$ENIQ_VOLUME_MT_POINT/gran/topologyData/LBG/LBG";
my $LBG_EV_SymLink="$ENIQ_ENIQM_LOC_PATH/gran/topologyData/LBG/LBG";
...
sub testcase()
{
	...
	################################ Testcase Execution #########################################
	print FT Date(),">>> Checking LBG topology file";
	print FT ENIQM_Lib::Check_Topology_file($LBG_T_FILE);
	print FT Date(),">>> Checking the Headder part of LBG Topology file";
	Check_Headder();
	print FT Date(),">>> Checking Stats symbolic link";
	print FT ENIQM_Lib::Check_Symbolic_Link($LBG_S_SymLink);
	print FT Date(),">>> Checking Events symbolic link";
	print FT ENIQM_Lib::Check_Symbolic_Link($LBG_EV_SymLink);
...
sub Check_Headder{
my @FILE_Content;
open(FH,"$LBG_T_FILE"),or $EXIT_CODE=12,die "'$LBG_T_FILE' No such file found\n";
@FILE_Content=<FH>;
close FH;
