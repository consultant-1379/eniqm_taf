...
my $TCID="TC_CORE_37";
my $TC_Name="Check Topology file for SAPC node";
my $TC_Result;
my $Total_time=0;
...
my @NODES;
my $NODE_TXT="/home/nmsadm/ENIQ-M_Automation_Suite/Nodes/SAPC.txt";
my $Topology_File;
my $T_PATH;
my $S_PATH;
my $EV_S_PATH;
...
sub testcase()
{
	...
	print FT Date(),">>> Checking Topology file for SAPC nodes";
	print FT "=============================================";
	
	print FT Date(),"Reading SAPC node info from '$NODE_TXT'";
