...
my $TCID="TC_SNMP_6";
my $TC_Name="Check Topology file for NTP node";
my $TC_Result;
my $Total_time=0;
...
my @NODES;
my $NODE_TXT="/home/nmsadm/ENIQ-M_Automation_Suite/Nodes/NTP.txt";
my $Topology_File;
my $T_PATH;
my $S_PATH;
my $EV_S_PATH;
...
sub testcase()
{
	...
	print FT Date(),">>> Checking Topology file for NTP nodes";
	print FT "=============================================";
	
	print FT Date(),"Reading NTP node info from '$NODE_TXT'";
