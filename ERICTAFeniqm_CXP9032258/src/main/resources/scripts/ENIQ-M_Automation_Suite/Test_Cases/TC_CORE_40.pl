...
my $TCID="TC_CORE_40";
my $TC_Name="Check Topology file for SCF node";
my $TC_Result;
my $Total_time=0;
...
my @NODES;
my $NODE_TXT="/home/nmsadm/ENIQ-M_Automation_Suite/Nodes/SCF.txt";
my $Topology_File;
my $T_PATH;
my $S_PATH;
my $EV_S_PATH;
...
sub testcase()
{
	...
	print FT Date(),">>> Checking Topology file for SCF nodes";
	print FT "=============================================";
	
	print FT Date(),"Reading SCF node info from '$NODE_TXT'";
