...
my $TCID="TC_SNMP_7";
my $TC_Name="Check Topology file for CS-AS node";
my $TC_Result;
my $Total_time=0;
...
my @NODES;
my $NODE_TXT="/home/nmsadm/ENIQ-M_Automation_Suite/Nodes/CS-AS.txt";
my $Topology_File;
my $T_PATH;
my $S_PATH;
my $EV_S_PATH;
...
sub testcase()
{
	...
	print FT Date(),">>> Checking Topology file for CS-AS nodes";
	print FT "=============================================";
	
	print FT Date(),"Reading CS-AS node info from '$NODE_TXT'";
