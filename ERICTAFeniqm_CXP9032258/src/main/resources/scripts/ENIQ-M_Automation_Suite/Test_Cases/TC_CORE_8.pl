...
my $TCID="TC_CORE_8";
my $TC_Name="Check Topology file for E-CSCF node";
my $TC_Result;
my $Total_time=0;
...
my @NODES;
my $NODE_TXT="/home/nmsadm/ENIQ-M_Automation_Suite/Nodes/E-CSCF.txt";
my $Topology_File;
my $T_PATH;
my $S_PATH;
my $EV_S_PATH;
...
sub testcase()
{
	...
	print FT Date(),">>> Checking Topology file for E-CSCF nodes";
	print FT "=============================================";
	
	print FT Date(),"Reading E-CSCF node info from '$NODE_TXT'";
