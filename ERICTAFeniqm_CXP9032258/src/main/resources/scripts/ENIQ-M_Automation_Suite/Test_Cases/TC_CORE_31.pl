...
my $TCID="TC_CORE_31";
my $TC_Name="Check Topology file for PGM-AP-WUIGM node";
my $TC_Result;
my $Total_time=0;
...
my @NODES;
my $NODE_TXT="/home/nmsadm/ENIQ-M_Automation_Suite/Nodes/PGM-AP-WUIGM.txt";
my $Topology_File;
my $T_PATH;
my $S_PATH;
my $EV_S_PATH;
...
sub testcase()
{
	...
	print FT Date(),">>> Checking Topology file for PGM-AP-WUIGM nodes";
	print FT "=============================================";
	
	print FT Date(),"Reading PGM-AP-WUIGM node info from '$NODE_TXT'";
