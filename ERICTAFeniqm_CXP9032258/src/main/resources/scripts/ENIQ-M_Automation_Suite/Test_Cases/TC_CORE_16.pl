...
my $TCID="TC_CORE_16";
my $TC_Name="Check Topology file for HSS-SM node";
my $TC_Result;
my $Total_time=0;
...
my @NODES;
my $NODE_TXT="/home/nmsadm/ENIQ-M_Automation_Suite/Nodes/HSS-SM.txt";
my $Topology_File;
my $T_PATH;
my $S_PATH;
my $EV_S_PATH;
...
sub testcase()
{
	...
	print FT Date(),">>> Checking Topology file for HSS-SM nodes";
	print FT "=============================================";
	
	print FT Date(),"Reading HSS-SM node info from '$NODE_TXT'";
