...
my $TCID="TC_CORE_41";
my $TC_Name="Check Topology file for SCP-T node";
my $TC_Result;
my $Total_time=0;
...
my @NODES;
my $NODE_TXT="/home/nmsadm/ENIQ-M_Automation_Suite/Nodes/SCP-T.txt";
my $Topology_File;
my $T_PATH;
my $S_PATH;
my $EV_S_PATH;
...
sub testcase()
{
	...
	print FT Date(),">>> Checking Topology file for SCP-T nodes";
	print FT "=============================================";
	
	print FT Date(),"Reading SCP-T node info from '$NODE_TXT'";
