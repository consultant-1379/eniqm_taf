...
my $TCID="TC_CORE_28";
my $TC_Name="Check Topology file for P-CSCF node";
my $TC_Result;
my $Total_time=0;
...
my @NODES;
my $NODE_TXT="/home/nmsadm/ENIQ-M_Automation_Suite/Nodes/P-CSCF.txt";
my $Topology_File;
my $T_PATH;
my $S_PATH;
my $EV_S_PATH;
...
sub testcase()
{
	...
	print FT Date(),">>> Checking Topology file for P-CSCF nodes";
	print FT "=============================================";
	
	print FT Date(),"Reading P-CSCF node info from '$NODE_TXT'";
