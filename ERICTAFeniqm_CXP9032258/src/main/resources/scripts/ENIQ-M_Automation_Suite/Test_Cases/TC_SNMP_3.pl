...
my $TCID="TC_SNMP_3";
my $TC_Name="Check Topology file for HP-MRFP node";
my $TC_Result;
my $Total_time=0;
...
my @NODES;
my $NODE_TXT="/home/nmsadm/ENIQ-M_Automation_Suite/Nodes/HP-MRFP.txt";
my $Topology_File;
my $T_PATH;
my $S_PATH;
my $EV_S_PATH;
...
sub testcase()
{
	...
	print FT Date(),">>> Checking Topology file for HP-MRFP nodes";
	print FT "=============================================";
	
	print FT Date(),"Reading HP-MRFP node info from '$NODE_TXT'";
