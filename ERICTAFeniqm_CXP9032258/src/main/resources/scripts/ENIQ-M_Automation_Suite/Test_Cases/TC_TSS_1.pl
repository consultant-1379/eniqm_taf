...
my $TCID="TC_TSS_1";
my $TC_Name="Check Topology file for AXD301 node";
my $TC_Result;
my $Total_time=0;
...
my @NODES;
my $NODE_TXT="/home/nmsadm/ENIQ-M_Automation_Suite/Nodes/AXD301.txt";
my $Topology_File;
my $T_PATH;
my $S_PATH;
my $EV_S_PATH;
...
sub testcase()
{
	...
	print FT Date(),">>> Checking Topology file for AXD301 nodes";
	print FT "=============================================";
	
	print FT Date(),"Reading AXD301 node info from '$NODE_TXT'";
	...
	foreach(@NODES)
	{
		...
		$T_PATH="$ENIQ_VOLUME_MT_POINT/outputfiles/tss/topologyData/AXD301/$Topology_File";
