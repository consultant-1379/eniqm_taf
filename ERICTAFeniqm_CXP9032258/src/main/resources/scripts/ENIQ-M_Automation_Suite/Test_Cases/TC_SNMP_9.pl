...
my $TCID="TC_SNMP_9";
my $TC_Name="Check Topology file for CS-DS node";
my $TC_Result;
my $Total_time=0;
...
my @NODES;
my $NODE_TXT="/home/nmsadm/ENIQ-M_Automation_Suite/Nodes/CS-DS.txt";
my $Topology_File;
my $T_PATH;
my $S_PATH;
my $EV_S_PATH;
...
sub testcase()
{
	...
	print FT Date(),">>> Checking Topology file for CS-DS nodes";
	print FT "=============================================";
	
	print FT Date(),"Reading CS-DS node info from '$NODE_TXT'";
