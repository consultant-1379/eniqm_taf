...
my $TCID="TC_CORE_18";
my $TC_Name="Check Topology file for IMS-CO-ICS node";
my $TC_Result;
my $Total_time=0;
...
my @NODES;
my $NODE_TXT="/home/nmsadm/ENIQ-M_Automation_Suite/Nodes/IMS-CO-ICS.txt";
my $Topology_File;
my $T_PATH;
my $S_PATH;
my $EV_S_PATH;
...
sub testcase()
{
	...
	print FT Date(),">>> Checking Topology file for IMS-CO-ICS nodes";
	print FT "=============================================";
	
	print FT Date(),"Reading IMS-CO-ICS node info from '$NODE_TXT'";
