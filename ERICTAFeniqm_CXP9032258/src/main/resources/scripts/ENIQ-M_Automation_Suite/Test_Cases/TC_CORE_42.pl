...
my $TCID="TC_CORE_42";
my $TC_Name="Check Topology file for S-CSCF node";
my $TC_Result;
my $Total_time=0;
...
my @NODES;
my $NODE_TXT="/home/nmsadm/ENIQ-M_Automation_Suite/Nodes/S-CSCF.txt";
my $Topology_File;
my $T_PATH;
my $S_PATH;
my $EV_S_PATH;
...
sub testcase()
{
	...
	print FT Date(),">>> Checking Topology file for S-CSCF nodes";
	print FT "=============================================";
	
	print FT Date(),"Reading S-CSCF node info from '$NODE_TXT'";
