...
my $TCID="TC_CORE_36";
my $TC_Name="Check Topology file for PTT-AS node";
my $TC_Result;
my $Total_time=0;
...
my @NODES;
my $NODE_TXT="/home/nmsadm/ENIQ-M_Automation_Suite/Nodes/PTT-AS.txt";
my $Topology_File;
my $T_PATH;
my $S_PATH;
my $EV_S_PATH;
...
sub testcase()
{
	...
	print FT Date(),">>> Checking Topology file for PTT-AS nodes";
	print FT "=============================================";
	
	print FT Date(),"Reading PTT-AS node info from '$NODE_TXT'";
