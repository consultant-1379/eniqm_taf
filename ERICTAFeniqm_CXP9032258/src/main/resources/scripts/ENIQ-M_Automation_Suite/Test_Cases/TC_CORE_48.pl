...
my $TCID="TC_CORE_48";
my $TC_Name="Check Topology file for TSC node";
my $TC_Result;
my $Total_time=0;
...
my @NODES;
my $NODE_TXT="/home/nmsadm/ENIQ-M_Automation_Suite/Nodes/TSC.txt";
my $Topology_File;
my $T_PATH;
my $S_PATH;
my $EV_S_PATH;
...
sub testcase()
{
	...
	print FT Date(),">>> Checking Topology file for TSC nodes";
	print FT "=============================================";
	
	print FT Date(),"Reading TSC node info from '$NODE_TXT'";
